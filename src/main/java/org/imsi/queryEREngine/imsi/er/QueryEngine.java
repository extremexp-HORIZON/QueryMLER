...
public class QueryEngine {
	...
	private void initializeDB(CalciteConnection calciteConnection) throws SQLException {
		...
		// Skip initialization test query if no tables are loaded yet
		if(fSchema.isEmpty() || fTable.isEmpty()) {
			System.out.println("No tables found - skipping initialization test query.");
			System.out.println("Database will be initialized when datasets are loaded via /api/load-dataset");
